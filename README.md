...
This repository holds part of the demo in *[Manage your EKS Cluster with CDK](http://cdk-eks-devops.workshop.aws/)* Hands-on Lab.

Please follow [this link](http://cdk-eks-devops.workshop.aws/) to play with the lab. :)
